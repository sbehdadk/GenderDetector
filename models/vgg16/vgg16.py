...
class MobileNetDeepEstimator:
    ...
    def __preprocessing__wiki(self, val_split=0.2, batch_size=128):
        ...
        logging.debug('data preprocessing wiki...')
    ...
    def __preprocessing__imdb(self, val_split=0.2, batch_size=128):
        ...
        ground_truth_data = data_loader.get_data()
        train_keys_imdb, val_keys_imdb = split_imdb_data(ground_truth_data, val_split)
        ...
        logging.debug('data preprocessing imdb...')
    ...
    def __call__(self):
        ...
        base_model = vgg16.VGG16(input_shape=self._input_shape,
        ...
        history_wiki = model.fit_generator(image_generator.flow(mode='train'),
        ...
        logging.debug('15 Layers are freezed...')    
        ...
        mk_dir("models")
        with open(os.path.join("models/vgg16", "vgg16.json"), "w") as f:
            f.write(model.to_json())
    
        mk_dir("checkpoints/vgg16")
        ...
        model_checkpoint = ModelCheckpoint(
                    os.path.join('checkpoints/vgg16', 'val_vgg16_imdb_128_10Epoch_Adam.{epoch:02d}-{val_loss:.2f}.hdf5'),
                    monitor="val_loss",
                    verbose=1,
                    save_best_only=True,
                    mode="auto",
        ...
        history_imdb = model.fit_generator(image_generator_imdb.flow(mode='train'),
                                      ...
                                      epochs=self.nb_epochs+10, verbose=1,
                                      callbacks=callbacks,
